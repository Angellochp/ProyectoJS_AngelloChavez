...
/* fetch("https://github.com/Angellochp/JS_CoderHouse_Angello_Chavez/blob/main/data.jsongit status")
.then (response => response.json())
.then(data =>console.log (data)) */
  
  /* data.forEach(item => {
    let precios = localStorage.setItem("precios", JSON.stringify(precios))
